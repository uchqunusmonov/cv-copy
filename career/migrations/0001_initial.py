# Generated by Django 4.0.1 on 2022-04-02 10:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dutie', ckeditor.fields.RichTextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pros', ckeditor.fields.RichTextField()),
                ('created_date', models.DateField(auto_now_add=True)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('duties', models.ManyToManyField(blank=True, to='career.Duties')),
                ('pros', models.ManyToManyField(blank=True, to='career.Pros')),
                ('requirements', models.ManyToManyField(blank=True, to='career.Requirements')),
                ('skills', models.ManyToManyField(blank=True, to='career.Skills')),
            ],
            options={
